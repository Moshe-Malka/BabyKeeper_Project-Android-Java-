 ...
 */
public class SensorDataRequest_Humidity extends StringRequest{

    // path to .PHP files that handel getting the data from the remote database.
    static final String HUMIDITY_TABLE_REQUEST_URL = "http://babykeeper.netai.net/getHumidityTableValues.php";
     ...
     */
    public SensorDataRequest_Humidity(String raspberry_product_key,
                                      String timeRange,
                                      Response.Listener<String> listener) {
        super(Method.POST, HUMIDITY_TABLE_REQUEST_URL, listener, null);
        params = new HashMap<>();
